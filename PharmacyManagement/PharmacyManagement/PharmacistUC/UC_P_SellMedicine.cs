...
namespace PharmacyManagement.PharmacistUC
{
    public partial class UC_P_SellMedicine : UserControl
    {
        ...
        private void listBoxMedicines_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtExpireName.Text = ds.Tables[0].Rows[0][1].ToString();   //xtxExpeireName = txtExpireDate
        ...
        private void btnAddToCart_Click(object sender, EventArgs e)
        {
            ...
            if (txtMediId.Text != "")
            {
                ...
                newQuantity = quantity - Int64.Parse(txtNoOfUnits.Text);  //60 -10
                ...
                if (newQuantity >= 0)
                {
                    ...
                    guna2DataGridView1.Rows[n].Cells[2].Value = txtExpireName.Text;
                    ...
                    query = " update medic set quantity = '" + newQuantity + "' where mid ='" + txtMediId + "'";
                    fn.setData(query, "medicine Added.");

                }
                else
                {
                    MessageBox.Show("İlaç Tükendi. \n Sadece " + quantity + " Sol", "Uyarı !", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                clearAll();
                UC_P_SellMedicine_Load(this, null);
            }
            ...
            {
                MessageBox.Show("önce ilacı seç.", "bilgi !", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        //**
        int valueAmount;
